...
import os.path
import sys 
sys.path.append('/mnt/c/my_script/TCR')
import getopt
...
# diff_analysis_r='/mnt/c/my_script/TCR/TCR_diff_analysis.r'
diff_analysis_r=os.path.split(os.path.abspath(sys.argv[0]))[0] + '/TCR_diff_analysis.r'
